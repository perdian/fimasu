...
public class QifGeneratorApplication extends AbstractApplication {
    ...
    protected Pane createMainPane() {
        ...
        log.debug("Creating QifGeneratorPane");
        return new QifGeneratorPane(transactionGroups, this.getPreferences());
    ...
    protected Scene createMainScene(Pane mainPane) {
        ...
        scene.getStylesheets().add("META-INF/stylesheets/qifgenerator.css");
        return scene;
    }
