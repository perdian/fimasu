...
class TransactionPane extends VBox {
    ...
    TransactionPane(Transaction transaction, ObservableList<Transaction> transactions, EventHandler<ActionEvent> deleteHandler) {
        ...
        this.append(topPane, componentBuilder.createLabel("Value"), 4, 0, 1, 1, null, Priority.NEVER, false);
        this.append(topPane, componentBuilder.createTextField(transaction.valueProperty(), new DoubleStringConverter("0")), 4, 1, 1, 1, 60, Priority.NEVER, false);
