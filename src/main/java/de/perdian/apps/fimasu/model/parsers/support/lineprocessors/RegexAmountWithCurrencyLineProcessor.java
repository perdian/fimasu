...
public class RegexAmountWithCurrencyLineProcessor extends RegexLineProcessor {
    ...
    private WritableValue<BigDecimal> amountProperty = null;
    private WritableValue<String> currencyProperty = null;
    private Mode mode = null;
    private Supplier<Double> signComputer = null;

    public RegexAmountWithCurrencyLineProcessor(String pattern, WritableValue<BigDecimal> amountProperty, NumberFormat amountFormat, WritableValue<String> currencyProperty, RegexAmountWithCurrencyLineProcessor.Mode mode) {
        this(pattern, amountProperty, amountFormat, currencyProperty, mode, () -> 1d);
    }

    public RegexAmountWithCurrencyLineProcessor(String pattern, WritableValue<BigDecimal> amountProperty, NumberFormat amountFormat, WritableValue<String> currencyProperty, RegexAmountWithCurrencyLineProcessor.Mode mode, Supplier<Double> signComputer) {
        super(pattern);
    ...
    protected void processLineWithMatcher(String line, Matcher lineMatcher) {
        ...
        try {
            if (this.getAmountProperty() != null) {
                ...
                this.getAmountProperty().setValue(BigDecimal.valueOf(newAmount.doubleValue()));
            }
    ...
    private WritableValue<BigDecimal> getAmountProperty() {
        return this.amountProperty;
    }
    private void setAmountProperty(WritableValue<BigDecimal> amountProperty) {
